...
const TAG_COLORS = ["#C6432C", "#E0A11C", "#2E7D74", "#3B6FB0", "#8A5A9E", "#B07A2E", "#4C7A34", "#C05A8A"];
const tagColor = (tags, id) => {
  const i = (tags || []).findIndex(t => t.id === id);
  return TAG_COLORS[(i < 0 ? 0 : i) % TAG_COLORS.length];
};
const tagLabel = (tags, id) => {
...
function App() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setTags(await loadKey(K.tags, DEFAULT_TAGS));
  ...
  function renameTag(id, label) {
    setTags(p => p.map(t => t.id === id ? {
      ...t,
      label
    } : t));
  }
  ...
  }), catModal && /*#__PURE__*/React.createElement(CategoriesModal, {
    tags: tags,
    onAdd: addTag,
    onRename: renameTag,
    onDelete: deleteTag,
...
function ScheduleView({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      const mealAllowed = sel ? !(selRec?.meals || []).length || (selRec?.meals || []).includes(m.id) : true;
      return /*#__PURE__*/React.createElement("div", {
        key: m.id,
        style: {
          background: C.paper,
        ...
        const canPlace = sel && okDay && mealAllowed;
        return /*#__PURE__*/React.createElement("div", {
          key: p,
...
function RecipesView({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    ...
    size: 18
  }), " New recipe"), /*#__PURE__*/React.createElement("button", {
    ...
    const hasRating = r.taste || r.ease || r.prepMin;
    return /*#__PURE__*/React.createElement("button", {
      key: r.id,
      onClick: () => onEdit(r),
      style: {
    ...
    }, "+ ", r.side), hasRating && /*#__PURE__*/React.createElement("div", {
      style: {
        fontSize: 12,
        color: C.ink,
        marginTop: 5,
    ...
    }, r.taste ? /*#__PURE__*/React.createElement("span", {
      style: {
        color: C.turmeric
      }
    }, "\u2605 ", r.taste, "/10") : null, r.ease ? /*#__PURE__*/React.createElement("span", {
      style: {
        color: C.teal
      }
    }, "\u26A1 ", r.ease, "/10") : null, r.prepMin ? /*#__PURE__*/React.createElement("span", {
      style: {
        color: C.muted
      }
    }, "\u23F1 ", r.prepMin, "m") : null), /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        flexWrap: "wrap",
        gap: 5,
    ...
    }), (r.tags || []).map(t => /*#__PURE__*/React.createElement(TagChip, {
      key: t,
      label: tagLabel(tags, t),
      color: tagColor(tags, t)
    }))));
  })));
}
...
function RecipePicker({
  ...
  return /*#__PURE__*/React.createElement(Overlay, {
    ...
    const col = tagColor(tags, s.id);
    const on = styleF.includes(s.id);
    return /*#__PURE__*/React.createElement("button", {
      key: s.id,
      ...
      style: {
        ...
        padding: "5px 10px",
        borderRadius: 999,
        border: `1.5px solid ${on ? col : C.sage}`,
  ...
  }, "serves ", r.serves, " \xB7 keeps ", r.lasts, "d", (r.tags || []).length ? " · " + r.tags.map(t => tagLabel(tags, t)).join(", ") : "")), /*#__PURE__*/React.createElement(Plus, {
    size: 18,
    color: C.muted
  })))));
}
...
function RecipeEditor({
  ...
  return /*#__PURE__*/React.createElement(Overlay, {
  ...
  }, tags.map(s => /*#__PURE__*/React.createElement(Toggle, {
    key: s.id,
    on: (r.tags || []).includes(s.id),
    onClick: () => toggleIn("tags", s.id),
    color: tagColor(tags, s.id)
    ...
    value: r.prepMin || "",
    onChange: e => set({
      prepMin: e.target.value ? +e.target.value : undefined
    }),
    placeholder: "\u2014",
    style: inp
  }))), /*#__PURE__*/React.createElement("div", {
...
function CategoriesModal({
  ...
  }, "Rename or remove your dish categories, or add new ones. Changes apply everywhere."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
      gap: 8
    }
  ...
  }, "No categories yet.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: 6,
      marginTop: 12
...
function BackupModal({
  ...
  }, "Save everything (recipes, week, shopping, categories) to a file, or restore from one \u2014 handy when you switch phones."), /*#__PURE__*/React.createElement("button", {
    onClick: onExport,
    style: {
      width: "100%",
      background: C.ink,
